...
const currencyByLocale = { en: 'USD', ja: 'JPY', it: 'EUR' }
const currentCurrency = computed(() => currencyByLocale[currentLocale.value] || 'USD')
...
export function useI18n() {
  ...
  const translateWarehouse = (warehouseName) => {
    ...
    if (currentLocale.value === 'it') {
      ...
      if (warehouseName.startsWith('Warehouse ')) {
        return warehouseName.replace('Warehouse ', 'Magazzino ')
      }
