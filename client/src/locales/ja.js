export default {
  ...
  restocking: {
    title: '補充推奨',
    subtitle: 'アルゴリズムが購入計画を提案します。発注はあなたが決定します。',
    budgetLabel: '予算',
    ...
    budgetRemaining: '残り',
    deferred: '保留（予算超過）',
    recommendationsTitle: '推奨発注書',
    selectAll: 'すべて選択',
    clearSelection: 'クリア',
    generatePOs: '発注書を生成',
    empty: '補充は不要です — すべての商品が現在の予測で再注文点以上にあります。',
    priority: '優先度',
    sku: 'SKU',
    itemName: '品目',
    warehouse: '倉庫',
    ...
    lineCost: '行コスト',
    summaryTitle: '発注書を確認',
    summaryIntro: '{count}件の発注書を生成しようとしています。',
    summaryTotalCost: '合計コスト',
    summaryByWarehouse: '倉庫別内訳',
    summaryNote: '発注書はドラフトとして作成されます。サプライヤーに送信する前に編集できます。',
    cancel: '閉じる',
    confirmGenerate: '生成',
    submitting: '生成中…',
    resultAllOk: '{count}件の発注書ドラフトを作成しました。',
    resultAllFailed: '{count}件の発注書すべての作成に失敗しました。',
    resultMixed: '{ok}件成功、{failed}件失敗。',
    loadError: '補充データの読み込みに失敗しました'
  },

  // Reports
  reports: {
    title: 'パフォーマンスレポート',
    subtitle: '四半期パフォーマンス指標と月次トレンド',
    ...
    change: '変化',
    growthRate: '成長率',
    summaryRevenue: '総収益（期間）',
    summaryAvgMonthly: '平均月次収益',
    summaryTotalOrders: '総注文数（期間）',
    summaryBestQuarter: '最高業績四半期',
  ...
  dashboard: {
    ...
    pareto: {
      title: 'パレート / ABC分析',
      subtitle: '注文を分類 — A: 上位80%、B: 80〜95%、C: 95〜100%',
      classA: 'クラスA',
      classB: 'クラスB',
      classC: 'クラスC',
      orders: '注文',
      ...
      cumulative: '累計 %',
      metric: '指標',
      metricOrderValue: '注文金額',
      metricItemCount: '注文あたりの商品数',
      xAxis: '注文（順位順）',
      filterActive: 'クラス{cls}でフィルター中',
      clearFilter: 'フィルター解除'
    },
